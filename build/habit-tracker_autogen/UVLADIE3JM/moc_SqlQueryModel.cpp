...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SqlQueryModel_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SqlQueryModel_t qt_meta_stringdata_SqlQueryModel = {
    {
        QT_MOC_LITERAL(0, 13),  // "SqlQueryModel"
        QT_MOC_LITERAL(14, 7),  // "refresh"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 5)   // "query"
    },
    "SqlQueryModel",
    "refresh",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_SqlQueryModel[] = {
...
Q_CONSTINIT const QMetaObject SqlQueryModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QSqlQueryModel::staticMetaObject>(),
    qt_meta_stringdata_SqlQueryModel.offsetsAndSizes,
    qt_meta_data_SqlQueryModel,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SqlQueryModel_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SqlQueryModel, std::true_type>,
        // method 'refresh'
